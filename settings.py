...
COMPOSER_KEYBOARD_BIND_TO_BIND_TYPE = {
    COMPOSER_KEY_BINDS[0] : COMPOSER_KEY_BINDS_TYPES[0],
    COMPOSER_KEY_BINDS[1] : COMPOSER_KEY_BINDS_TYPES[1],
    COMPOSER_KEY_BINDS[2] : COMPOSER_KEY_BINDS_TYPES[2],
    COMPOSER_KEY_BINDS[3] : COMPOSER_KEY_BINDS_TYPES[3],
    COMPOSER_KEY_BINDS[4] : COMPOSER_KEY_BINDS_TYPES[4],
    COMPOSER_KEY_BINDS[5] : COMPOSER_KEY_BINDS_TYPES[5],
    COMPOSER_KEY_BINDS[6] : COMPOSER_KEY_BINDS_TYPES[6],
    
} 
COMPOSER_BIND_TYPE_TO_KEYBOARD_BIND = {
    COMPOSER_KEY_BINDS_TYPES[0] : COMPOSER_KEY_BINDS[0],
    COMPOSER_KEY_BINDS_TYPES[1] : COMPOSER_KEY_BINDS[1],
    COMPOSER_KEY_BINDS_TYPES[2] : COMPOSER_KEY_BINDS[2],
    COMPOSER_KEY_BINDS_TYPES[3] : COMPOSER_KEY_BINDS[3],
    COMPOSER_KEY_BINDS_TYPES[4] : COMPOSER_KEY_BINDS[4],
    COMPOSER_KEY_BINDS_TYPES[5] : COMPOSER_KEY_BINDS[5],
    COMPOSER_KEY_BINDS_TYPES[6] : COMPOSER_KEY_BINDS[6],
}
